...
// CV最適化: 電話前の最大の不安（即日/無料/遠方）を先頭に並べ替え＋新設。
// 既存4問（近隣配慮・保険・見積時間・作業時間・夜間）は事実の文言を維持。
const FAQ_ITEMS: FaqItem[] = [
  {
    question: "すぐに来てもらえますか？",
    answer:
      "東京・神奈川を中心に、最短即日で現地確認に伺います。お急ぎの場合は、まずはお電話（9:00〜21:00 年中無休）でご相談ください。",
  },
  {
    question: "相談や見積りにお金はかかりますか？",
    answer:
      "ご相談・お見積り・出張費用はすべて無料です。お見積り確定後の追加費用もありません。金額にご納得いただいてから作業を開始します。",
  },
  {
    question: "遠方に住んでいて立ち会えません。依頼できますか？",
    answer:
        ...
        {FAQ_ITEMS.map((item) => (
          <div key={item.question} className="py-5 first:pt-1 last:pb-1">
            ...
            <div className="mt-2.5 flex items-start gap-2.5">
              ...
              <p className="pt-[2px] text-[clamp(11.5px,3vw,13px)] leading-[1.9] text-[#4b5450] [word-break:auto-phrase]">
                {item.answer}
              </p>
            </div>
          </div>
