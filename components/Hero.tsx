...
const HOTSPOTS: Hotspot[] = [
  { label: "電話で相談する 03-4400-2098", href: PHONE, left: "58.5%", top: "1.1%", width: "21.8%", height: "6.5%" },
  { label: "LINEで写真相談する", href: LINE, external: true, left: "82%", top: "1.2%", width: "16%", height: "6.4%" },
  { label: "電話で今すぐ相談する 03-4400-2098", href: PHONE, left: "1.7%", top: "55.5%", width: "47.1%", height: "10.3%" },
  { label: "LINEで写真を送って相談する", href: LINE, external: true, left: "50.3%", top: "55.5%", width: "48.1%", height: "10.3%" },
];
...
export default function Hero() {
  return (
    <section className="relative w-full">
      ...
      {/* transparent interactive hotspots over the baked CTAs */}
      {HOTSPOTS.map((h) => (
        <a
          key={h.label + h.top}
          href={h.href}
