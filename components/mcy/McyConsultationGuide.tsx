...
export default function McyConsultationGuide() {
  return (
    <section
      ...
      className="mx-3 mb-5 mt-4 overflow-hidden rounded-[18px] border border-[#d8c7a0] bg-white text-lux-green-ink tracking-normal shadow-[0_6px_20px_rgba(18,61,40,0.06)]"
    >
      <div className="px-4 pb-5 pt-5 min-[390px]:px-5">
        ...
        <div className="mt-5 border-l-2 border-lux-gold pl-3">
          ...
          <p className="mt-1 text-[14px] leading-6 text-[#526259]">写真がなくてもご相談いただけます。</p>
        </div>
      </div>

      <div className="bg-[#f0f5f1] px-3 pb-4 pt-4 min-[390px]:px-5">
        <ol aria-label="相談からご契約まで" className="relative grid grid-cols-3 gap-2 text-center before:absolute before:left-[16.666%] before:right-[16.666%] before:top-[19px] before:border-t before:border-[#bfcec2]">
          <li className="relative">
            ...
            <p className="mt-1 text-[12px] leading-5 text-[#526259]">電話・LINEで</p>
          </li>
          <li className="relative">
            <span aria-hidden="true" className="relative mx-auto grid h-10 w-10 place-items-center rounded-full border border-[#bfcec2] bg-white text-lux-green">
            ...
            <p className="mt-1 text-[12px] leading-5 text-[#526259]">お見積り</p>
          </li>
          <li>
            <span aria-hidden="true" className="relative mx-auto grid h-10 w-10 place-items-center rounded-full border border-[#bfcec2] bg-white text-lux-green">
            ...
            <p className="mt-1 text-[12px] leading-5 text-[#526259]">納得してから</p>
          </li>
        </ol>
      </div>
      <a href="#nagare" data-gtm="consultation_guide_flow" className="flex min-h-[52px] items-center justify-between gap-3 border-t border-[#dce5dd] px-4 text-[14px] font-bold transition-colors hover:bg-[#f0f5f1] focus-visible:outline-2 focus-visible:-outline-offset-4 focus-visible:outline-lux-green min-[390px]:px-5">
        ご依頼の流れを詳しく見る
