        ...
        <div data-cta-section className="mx-auto mt-[clamp(14px,3.8vw,20px)] max-w-[460px] rounded-[18px] border border-lux-green/15 bg-white p-px">
          <div className="relative rounded-[16px] bg-white px-4 pb-5 pt-4 text-lux-green-ink">
            ...
            <a
              ...
              className="mcy-cta-nudge relative mt-4 flex min-h-[clamp(82px,20vw,96px)] items-center justify-center gap-2 overflow-hidden rounded-full bg-[#c0202a] px-3 py-[clamp(9px,2.7vw,13px)] text-white transition-[filter] active:brightness-95"
            >
              ...
              <span className="min-w-0 text-center leading-none">
                ...
                <span className="mt-[4px] block text-[12px] leading-5 font-bold opacity-95">
            ...
            <div
              ...
              className="mcy-cta-nudge mt-3 rounded-full bg-[#087f36] p-px"
            >
            <a
              href={LINE_URL}
              target="_blank"
              ...
              className="relative flex min-h-[clamp(82px,20vw,96px)] items-center justify-center gap-2 overflow-hidden rounded-full bg-[#087f36] px-3 py-[clamp(9px,2.7vw,13px)] text-white transition-[filter] active:brightness-90"
            >
