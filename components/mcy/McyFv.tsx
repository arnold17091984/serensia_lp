    ...
    <section className="relative w-full overflow-hidden bg-white">
      ...
      <div data-cta-section className="relative w-full">
        ...
        <a
          ...
          className="absolute left-[3.4%] top-[54.9%] h-[9.3%] w-[93.2%] rounded-[16px] transition-colors active:bg-black/10"
        />
        ...
        <a
          ...
          className="absolute left-[3%] top-[64.3%] h-[11.5%] w-[94%] rounded-[16px] transition-colors active:bg-black/10"
        />
      </div>
    </section>
  );
