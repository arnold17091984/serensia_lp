 ...
 * White glass ground / navy brand / glossy turquoise & LINE-green CTAs / gold accents.
...
export default function McyHeader() {
  return (
    <header className="sticky top-0 z-40 w-full bg-white/85 shadow-[0_2px_14px_rgba(18,58,92,0.12)] backdrop-blur-md">
