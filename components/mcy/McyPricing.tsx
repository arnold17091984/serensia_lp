 ...
 * Reference-grade visual language: sky→white gradient ground with soft radial
 * glows + micro dots, "PRICE" watermark heading, gold double-framed glass entry
 * card with ribbon tab, navy→turquoise gradient case headers, white-framed
 * before/after photos with gradient label chips, 2-column work chips, and a
 * glossy LINE pill CTA. Prices keep the vermilion accent (#c0392b).
 */
  ...
  return (
    <ul className="mt-[6px] grid grid-cols-2 gap-[5px]">
      {items.map((w) => (
        <li
          key={w}
          className="flex items-start gap-[5px] rounded-[8px] border border-mcy-turq/15 bg-mcy-sky px-[7px] py-[6px] text-[clamp(9.5px,2.7vw,12px)] font-medium leading-[1.55] text-mcy-navy/90"
        >
          <span
            aria-hidden="true"
            className="mt-[2px] grid h-[12px] w-[12px] shrink-0 place-items-center rounded-full bg-gradient-to-b from-mcy-turq-bright to-mcy-turq-deep text-[7.5px] font-black text-white shadow-[0_1px_3px_rgba(11,127,133,0.4)]"
          >
            ✓
          </span>
          <span>{w}</span>
...
function CaseDivider() {
  return (
    <div aria-hidden="true" className="flex items-center justify-center gap-[8px] py-[2px]">
      <span className="h-px w-[clamp(48px,20vw,100px)] bg-gradient-to-r from-transparent to-mcy-turq/40" />
      <span className="h-[6px] w-[6px] rotate-45 border border-mcy-gold/80 bg-mcy-gold-light" />
      <span className="h-px w-[clamp(48px,20vw,100px)] bg-gradient-to-l from-transparent to-mcy-turq/40" />
    </div>
  );
}
...
export default function McyPricing() {
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -left-[120px] -top-[80px] h-[360px] w-[360px] rounded-full bg-[radial-gradient(circle,rgba(43,199,205,0.18),transparent_65%)]"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -right-[140px] top-[34%] h-[420px] w-[420px] rounded-full bg-[radial-gradient(circle,rgba(18,165,171,0.13),transparent_65%)]"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -bottom-[120px] -left-[100px] h-[380px] w-[380px] rounded-full bg-[radial-gradient(circle,rgba(201,162,79,0.12),transparent_65%)]"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 opacity-60 [background-image:radial-gradient(rgba(18,165,171,0.09)_1px,transparent_1.4px)] [background-size:22px_22px]"
      />

      <div className="relative">
        {/* heading — turq pill → mincho navy (keyword turq) → gold ―◆― + PRICE watermark */}
        <div className="relative text-center">
          <span
            aria-hidden="true"
            className="pointer-events-none absolute left-1/2 top-[-0.34em] -translate-x-1/2 select-none whitespace-nowrap font-display text-[clamp(54px,16vw,84px)] font-black tracking-[0.05em] text-mcy-turq/10"
          >
            PRICE
          </span>
          <span aria-hidden="true" className="pointer-events-none absolute right-[6%] top-[6px] text-[clamp(12px,3.4vw,17px)] text-mcy-gold/70">
            ✦
          </span>
          <span aria-hidden="true" className="pointer-events-none absolute left-[8%] top-[58px] text-[clamp(9px,2.6vw,12px)] text-mcy-turq/50">
            ✦
          </span>

          <span className="relative inline-block rounded-full bg-gradient-to-r from-mcy-turq-bright via-mcy-turq to-mcy-turq-deep px-[clamp(16px,4.5vw,24px)] py-[clamp(5px,1.5vw,8px)] text-[clamp(10px,2.9vw,14px)] font-black tracking-[0.08em] text-white shadow-[0_4px_12px_rgba(11,127,133,0.3)] ring-1 ring-white/60">
            料金の目安が分かる
          </span>
          <h2 className="relative mt-[clamp(10px,2.8vw,15px)] font-display text-[clamp(22px,6.2vw,30px)] font-black tracking-[0.03em] text-mcy-navy">
            実績・<span className="text-mcy-turq-deep">参考料金</span>
          </h2>
          <span aria-hidden="true" className="mt-[clamp(8px,2.2vw,12px)] flex items-center justify-center gap-[7px]">
            <span className="h-px w-[clamp(30px,9vw,48px)] bg-gradient-to-r from-transparent to-mcy-gold" />
            <span className="h-[7px] w-[7px] rotate-45 border border-mcy-gold bg-mcy-gold-light shadow-[0_1px_3px_rgba(201,162,79,0.5)]" />
        ...
        <div className="relative mx-auto mt-[clamp(20px,5.4vw,30px)] max-w-[460px]">
          <div className="rounded-[22px] bg-gradient-to-br from-mcy-gold via-mcy-gold-light to-mcy-gold p-[2px] shadow-[0_10px_30px_rgba(18,58,92,0.14)]">
            <div className="relative rounded-[20px] bg-white/85 px-4 pb-5 pt-[clamp(24px,6.4vw,30px)] text-center backdrop-blur">
          ...
          {/* ribbon tab */}
          <span className="absolute left-1/2 top-0 -translate-x-1/2 -translate-y-1/2 bg-gradient-to-b from-mcy-gold to-mcy-gold-deep px-[clamp(20px,5.5vw,28px)] py-[clamp(5px,1.4vw,7px)] text-[clamp(10px,2.8vw,12.5px)] font-black tracking-[0.16em] text-white [clip-path:polygon(0_0,100%_0,92%_50%,100%_100%,0_100%,8%_50%)] [filter:drop-shadow(0_3px_6px_rgba(165,129,58,0.45))]">
            まずは目安
          </span>
        </div>
            ...
            <Fragment key={c.title}>
              ...
              <article className="overflow-hidden rounded-[18px] border border-white/70 bg-white shadow-[0_10px_30px_rgba(18,58,92,0.14)]">
                ...
                <div className="px-4 pb-4 pt-3">
                  {/* before/after — white-framed photos + gradient label chips + turq arrow */}
                  <div className="relative grid grid-cols-2 gap-2">
                    {[
                      { src: c.before, label: "施工前", en: "BEFORE", tone: "bg-gradient-to-b from-mcy-navy to-mcy-navy-deep" },
                      { src: c.after, label: "施工後", en: "AFTER", tone: "bg-gradient-to-b from-mcy-turq-bright to-mcy-turq-deep" },
                    ].map((p) => (
                      <figure key={p.en} className="relative">
                        <img
                          ...
                          loading="lazy"
                          decoding="async"
                          className="aspect-[4/3] w-full rounded-[10px] border-[3px] border-white object-cover shadow-[0_4px_14px_rgba(18,58,92,0.22)]"
                        />
                        <figcaption
                          className={`absolute left-[6px] top-[6px] rounded-[5px] ${p.tone} px-[7px] py-[3px] leading-none text-white shadow-[0_2px_6px_rgba(18,58,92,0.35)] ring-1 ring-white/70`}
                        >
                    ...
                    <span
                      aria-hidden="true"
                      className="pointer-events-none absolute left-1/2 top-1/2 z-[1] grid h-[26px] w-[26px] -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full bg-gradient-to-b from-mcy-turq-bright to-mcy-turq-deep shadow-[0_2px_8px_rgba(11,127,133,0.45)] ring-2 ring-white"
                    >
                  ...
                  {c.reasons && (
                    <div className="mt-3 rounded-[12px] border border-mcy-turq/20 bg-gradient-to-br from-mcy-turq-light to-mcy-sky px-3 py-[10px]">
                      <p className="text-[clamp(10px,2.8vw,12.5px)] font-black text-mcy-turq-deep">
                        ▼価格に幅が出る場合の主な理由
                      </p>
                      <ul className="mt-1 flex flex-col gap-[3px]">
                        {c.reasons.map((r) => (
                          <li key={r} className="flex items-start gap-[5px] border-b border-mcy-turq/10 pb-[3px] text-[clamp(10px,2.8vw,12.5px)] font-medium leading-[1.7] text-mcy-navy/85 last:border-b-0 last:pb-0">
                  ...
                  <div className="mt-3">
                    <p className="flex items-center gap-[7px] text-[clamp(11px,3.1vw,13.5px)] font-black text-mcy-navy">
                      <span aria-hidden="true" className="h-[15px] w-[4px] shrink-0 rounded-full bg-gradient-to-b from-mcy-turq-bright to-mcy-turq-deep" />
                      作業内容
                    </p>
                    {c.workGroups ? (
                      <div className="mt-[6px] flex flex-col gap-[10px]">
                        {c.workGroups.map((g) => (
                          <div key={g.label}>
                            <p className="inline-flex items-center gap-[6px] rounded-full bg-mcy-turq-light px-[11px] py-[3px] text-[clamp(10.5px,2.9vw,13px)] font-bold text-mcy-turq-deep">
                              <span aria-hidden="true" className="h-[5px] w-[5px] shrink-0 rotate-45 bg-mcy-turq" />
                              <span>{g.label}</span>
                            </p>
                  ...
                  {/* price row — right-aligned, vermilion price, gold underline */}
                  <div className="mt-3 flex flex-wrap items-end justify-between gap-x-3 gap-y-1 border-t border-mcy-gold/40 pt-3">
                    ...
                    <p className="ml-auto whitespace-nowrap border-b-[3px] border-mcy-gold pb-[3px] leading-none">
                      <span className="mr-1 text-[clamp(10px,2.8vw,12.5px)] font-black text-mcy-navy">参考価格</span>
                      <span className="font-display text-[clamp(26px,7.2vw,35px)] font-black tracking-[-0.01em] text-[#c0392b]">
                        {c.price}
                      </span>
        ...
        <div data-cta-section className="mx-auto mt-[clamp(18px,5vw,26px)] max-w-[460px] rounded-[18px] border border-white/70 bg-white/75 px-4 py-[clamp(14px,4vw,20px)] shadow-[0_10px_30px_rgba(18,58,92,0.12)] backdrop-blur">
          ...
          <div className="mt-3 rounded-full bg-gradient-to-b from-mcy-gold-light via-mcy-gold to-mcy-gold-deep p-[2px] shadow-[0_10px_24px_rgba(6,163,42,0.38)]">
            <a
              ...
              className="relative flex items-center gap-2 overflow-hidden rounded-full bg-gradient-to-b from-[#25d94e] via-[#12c33f] to-[#06a32a] px-4 py-[clamp(10px,3vw,14px)] text-white ring-2 ring-inset ring-white/60 transition-[filter] active:brightness-90"
            >
              <span
                aria-hidden="true"
                className="pointer-events-none absolute inset-x-[8%] top-[3px] h-[36%] rounded-full bg-gradient-to-b from-white/55 to-white/0"
              />
              ...
              <span
                aria-hidden="true"
                className="relative grid h-[22px] w-[22px] shrink-0 place-items-center rounded-full bg-white shadow-[0_2px_5px_rgba(0,0,0,0.15)]"
              >
