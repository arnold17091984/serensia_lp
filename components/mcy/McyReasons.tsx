...
const REASONS: ReadonlyArray<{ icon: ReactNode; title: string; desc: string }> = [
  ...
  },
  {
    ...
    desc: "まず現場の状況をお聞かせください。写真がなくてもご相談いただけます。金額にご納得いただいてから作業を開始し、確定後の追加費用は一切ありません。クレジットカードもご利用可能です。",
    icon: (
      <>
...
export default function McyReasons() {
  return (
    <section data-section="reasons" className="relative w-full overflow-hidden bg-lux-cream-3 px-4 py-[clamp(28px,8vw,46px)]">
